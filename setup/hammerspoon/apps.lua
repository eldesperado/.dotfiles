...
hs.hotkey.bind(mash.apps, 'p', function () hs.application.launchOrFocus("Pulse Secure") end)
...
hs.hotkey.bind(mash.apps, 'f', function () hs.application.launchOrFocus("Finder") end)
