...
alias ll='ls -FGlAhp'                       # Preferred 'ls' with long format implementation
...
alias j='jobs -l'                           # Show current command's job
...
alias ports='netstat -atp tcp | grep -i "listen"'   # ports:        Show all ports
